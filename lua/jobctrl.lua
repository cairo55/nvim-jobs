...
--- @class JobTable
--- @field [integer] Job
--- @field [string]  JobIdEntry

--- @class JobLineInfo
--- @field line string
--- @field lnum integer

--- @class JobWriterCallbacks
--- @field filter? fun(lines: string[])
--- @field post?   fun(job: Job, lineinfo: JobLineInfo[])

--- @class JobCallbacks
--- @field out?  JobWriterCallbacks
--- @field err?  JobWriterCallbacks
--- @field exit? fun(exit: vim.SystemCompleted)

--- @class JobOpts
--- @field buf? JobBufferOpts
--- @field cb?  JobCallbacks
...
local function chunker(cb, ctx)
    ...
    return function(err, data)
        ...
        if err then
            vim.notify("vim.system error: " .. err, loglvl.WARN)
            return
        end
...
function Job:kill(signal)
    ...
    if not self.obj then return 0 end
